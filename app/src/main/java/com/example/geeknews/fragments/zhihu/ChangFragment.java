 ...
 */
public class ChangFragment extends BaseFragment<ZhihuView<String>, ZhihuPresenter<ZhihuView<String>>> implements ZhihuView<String> {
    ...
    protected void initData() {
        ...
        presenter.getZhihu("",Integer.valueOf(mId), ZhihuApi.CHANGPING);
